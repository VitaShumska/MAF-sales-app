...
export const PASSWORD_REGEXP: any = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,}$/;
// export const PHONE_NUMBER_REGEXP: any = /(^\+[0-9]{2}|^\+[0-9]{2}\(0\)|^\(\+[0-9]{2}\)\(0\)|^00[0-9]{2}|^0)([0-9]{9}$|[0-9\-\s]{12}$)/;
export const PHONE_NUMBER_REGEXP: any = /(^[0-9\-\+]{8,20}$)/;
// 10000 === 10 seconds
